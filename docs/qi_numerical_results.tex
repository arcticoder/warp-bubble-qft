...
\subsection{Energy Requirements vs. Availability}
Recent comprehensive parameter scans have quantified the gap between available and required negative energy for macroscopic warp bubble formation:

\begin{equation}
\frac{|E_{\rm available}|}{|E_{\rm required}|} \sim 10^{-8}
\end{equation}
