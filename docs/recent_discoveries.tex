...
\begin{itemize}
  ...
  \item \textbf{Metric Backreaction:} A self-consistent factor \(\beta_{\rm backreaction} = 0.80 + 0.15\,e^{-\mu R}\) yields
    \(E_{\rm req}^{\rm refined}(0.10,2.3) = 1.9443254780147017\) (15.464\% reduction).  
