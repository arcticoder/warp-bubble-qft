...
| Cavity Q enhancement | `cavity_enhancement_factor` | Haroche & Raimond (book) | $Q \sim 10^6$ typical | `log10(1e6)/10 = 0.6` | ✗ (heuristic scaling) |
| Squeezing (dB) | `squeezing_db` | Walls & Milburn (book) | $S \sim 10$-15 dB typical | `15 dB → factor 1.5` | ✗ (effective approximation) |

**Legend**:
- ✓ = Formula implemented matches published derivation
- ≈ = Order-of-magnitude agreement with literature estimates
- ✗ = Heuristic/empirical model; no rigorous derivation
